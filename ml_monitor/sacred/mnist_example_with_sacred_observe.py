...
ex = Experiment()
ex.observers.append(MongoObserver(db_name="machine_learning_exp"))  # default is "sacred"
...
def train_model(batch_size=128, epochs=5):
    ...
    ex.info["test loss"] = score[0]

    return {"test accuracy": score[1]}


if __name__ == '__main__':
    ex.run()

    runs = MongoClient().machine_learning_exp.runs
    print(runs.find())
    # print(runs.find({"epochs": 3})
