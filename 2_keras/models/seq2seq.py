...
class S2sModel:
    ...
    def __init__(self, **kwargs):
        ...
        # add BOS, EOS, EMPTY
        self.num_decoder_tokens = kwargs.get("num_decoder_tokens", -1) + 3
    ...
    def fit(self, encoder_input_data, decoder_input_data, decoder_target_data, target_data, batch_size, epochs, **kwargs):
        """
